...
public class UploadedFile implements java.io.Serializable {
	...
	public UploadedFile(Publication publication, String fileName,
			String downloadLink, String inboxUrl, String pairtreeUrl,
			String contentType, String size, String pages, String uid,
			Integer fileOrder, Date dateUploaded, String uploadedBy,
			String ipAddress) {
