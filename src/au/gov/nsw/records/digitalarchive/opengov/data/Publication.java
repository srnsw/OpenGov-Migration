...
public class Publication implements java.io.Serializable {
	...
	public Publication(Member member, Archivist archivist, String title,
			String description, String datePublished, String type,
			String typeOther, String coverage, String language, String rights,
			String totalPages, String totalFiles, String status,
			Integer viewedTimes, Date lastViewed, Date lastUpdated,
			Date dateRegistered, Date dateApproved,
			Set<UploadedFile> uploadedFiles,
